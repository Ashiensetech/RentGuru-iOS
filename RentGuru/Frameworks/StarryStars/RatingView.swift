...
open class RatingView: UIView {
    ...
    func customInit() {
        ...
        if offImage == nil {
             // offImage = UIImage(named: "stars-blank", inBundle: bundle, compatibleWithTraitCollection: self.traitCollection)
            offImage = UIImage(named: "starryStars_off", in: bundle, compatibleWith: self.traitCollection)
        }
        if onImage == nil {
            // onImage = UIImage(named: "stars-full", inBundle: bundle, compatibleWithTraitCollection: self.traitCollection)
            onImage = UIImage(named: "starryStars_on", in: bundle, compatibleWith: self.traitCollection)
        }
        
        if halfImage == nil {
          //  halfImage = UIImage(named: "stars-half", inBundle: bundle, compatibleWithTraitCollection: self.traitCollection)
